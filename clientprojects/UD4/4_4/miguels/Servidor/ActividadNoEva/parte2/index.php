...
if (isset($_GET['resultados'])) {
  $cadenadeResultados = $_GET['resultados'];

  $historial = str_split($cadenadeResultados);
}
...
$cadenaResultados = implode("", $historial);
          ...
          <div class="card shadow-sm border-0">
            <div class="card-body p-4 text-center">
              <form action="index.php" method="get" class="mb-3">
                <input type="hidden" name="resultados" value="<?php echo htmlspecialchars($cadenaResultados, ENT_QUOTES, 'UTF-8'); ?>">
                <button type="submit" name="lanzar" value="1" class="btn btn-primary btn-lg">
                  Lanzar dado
                </button>
                <button type="submit" name="reset" value="1" class="btn btn-primary btn-lg">Reiniciar</button>
            ...
            <div>
              ...
              <?php if (!empty($historial)): ?>
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php foreach ($historial as $index => $valor): ?>
                      <tr>
                        <td><?= $index + 1 ?></td>
                        <td><?= $valor ?></td>
                      </tr>
